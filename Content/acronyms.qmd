...
| $t =$ time                                                   | $r =$ space (distance between two points, one-dimensional length) |              
...
| $n =$ amount of particles (objects)                          | <sub>H</sub>$\mathcal{C} = m \cdot c_0 = \frac{\Delta H}{\Delta T}  =$ heat capacity | 
